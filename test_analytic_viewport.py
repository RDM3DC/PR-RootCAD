...
try:
    ...
    from adaptivecad.analytic.primitives import (
        AnalyticSphere, AnalyticBox, AnalyticCylinder, 
        AnalyticTorus, AnalyticCapsule
    )
...
def create_test_scene():
    ...
    scene.add_primitive(AnalyticBox(size=(1.5, 1.0, 1.0), position=(-2, 0, 0), color=(0.0, 1.0, 0.0)))
    
    # Cylinder at (2, 0, 0) with radius 0.5 and height 2.0
    scene.add_primitive(AnalyticCylinder(radius=0.5, height=2.0, position=(2, 0, 0), color=(0.0, 0.0, 1.0)))
    
    # Capsule at (0, 2, 0) with radius 0.4 and height 1.5
    scene.add_primitive(AnalyticCapsule(radius=0.4, height=1.5, position=(0, 2, 0), color=(1.0, 1.0, 0.0)))
    
    # Torus at (0, -2, 0) with major radius 1.0 and minor radius 0.3
    scene.add_primitive(AnalyticTorus(major_radius=1.0, minor_radius=0.3, position=(0, -2, 0), color=(1.0, 0.0, 1.0)))
