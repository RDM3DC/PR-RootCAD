...
def analytic_available() -> bool:
    ...
    return (
        has("adaptivecad.aacore.sdf")
        and (
            has("adaptivecad.gui.analytic_viewport")
            or has("adaptivecad.analytic.analytic_viewport")
        )
        and has("OpenGL")
    )
...
def exporter_available() -> bool:
    ...
    return has("adaptivecad.aacore.extract.marching_export") and has("skimage") and has("stl")
